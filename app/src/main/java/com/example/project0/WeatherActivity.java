...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void getWeatherInfo(String cityName){
        String url = "http://api.weatherapi.com/v1/forecast.json?key=0ca92185585b4ce1868112349241301&q="+cityName+"&days=1&aqi=yes&alerts=yes";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if(isDay==1){
                        Picasso.get().load("https://cutewallpaper.org/23/mobile-wallpaper-sizes/870222371.jpg").into(backIV);
                    }
                    else{
                        Picasso.get().load("https://w0.peakpx.com/wallpaper/223/687/HD-wallpaper-mountains-night-androd-android-nature.jpg").into(backIV);
                    }
